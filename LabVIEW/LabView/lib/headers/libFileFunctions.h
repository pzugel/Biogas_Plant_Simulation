...
void update_methane_inflow(const char* outflow_infile, const char* methane_specfile, int flowVal);
void update_hydrolysis_inflow(const char* outflow_infile, const char* hydrolysis_specfile, double fraction, int flowVal);
void update_initial_hydrolysis_inflow(const char* hydrolysis_specfile, int flowVal);
