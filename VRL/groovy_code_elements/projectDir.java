...
public class projectDir implements java.io.Serializable {
  ...
  @MethodInfo(name="getDirectory", valueName="Directory",valueStyle="silent", hide=false)
  ...
  public Path manualDirectory(
    @ParamInfo(name="Project Directory", style="load-dialog", options="endings=[\".vrlp\"]; description=\"Path to project\"") String dir){
      System.out.println("dir: " + dir);
      return Paths.get(dir); 
  }
}
